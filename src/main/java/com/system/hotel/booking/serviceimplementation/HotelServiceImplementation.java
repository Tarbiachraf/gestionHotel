...
public class HotelServiceImplementation implements HotelService {
	...
	public HotelServiceImplementation(JavaMailSender mailSender, HotelRepository hotelRepository, UserRepository userRepository, HotelRoomTypeRepository hotelRoomTypeRepository) {
	...
	public void deleteHotelById(Long hotelId) {
		...
		if (hotel == null) {
			// Handle the case where the hotel is not found, for example, throw an exception or log a message
