...
public class BookingServiceImplementation implements BookingService {
    ...
    public BookingServiceImplementation(BookingRepository bookingRepository, RoomRepository roomRepository, UserRepository userRepository, HotelRoomTypeRepository hotelRoomTypeRepository) {
